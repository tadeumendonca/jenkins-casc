def call(Map stageParams) { 
    def statusCodeRun = sh label: 'Docker Run Unit Test', returnStatus: true, script: "docker run -p 3001:3000 --name ${env.BUILD_CONTAINER_ID} ${stageParams.appName} npm run test"
